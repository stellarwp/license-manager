...
final class Feature_ControllerTest extends HarborTestCase {
	...
	public function test_schema_plugin_variant_has_all_properties(): void {
		...
		$expected = [ 'slug', 'name', 'description', 'product', 'tier', 'type', 'is_available', 'in_catalog_tier', 'documentation_url', 'is_enabled', 'plugin_file', 'released_at', 'version', 'changelog', 'is_dot_org', 'installed_version', 'update_version' ];
	...
	public function test_schema_theme_variant_has_installable_properties(): void {
		...
		$expected = [ 'slug', 'name', 'description', 'product', 'tier', 'type', 'is_available', 'in_catalog_tier', 'documentation_url', 'is_enabled', 'released_at', 'version', 'changelog', 'is_dot_org', 'installed_version', 'update_version' ];
