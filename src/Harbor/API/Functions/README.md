...
| `lw_harbor_is_product_license_active( $product )`                    | Whether a product slug has `validation_status: valid` in the cached portal                    |
| `lw_harbor_is_feature_enabled( $slug )`                              | Whether a feature is in the portal AND currently enabled/active                               |
| `lw_harbor_is_feature_available( $slug )`                            | Whether a feature exists in the portal, regardless of enabled state                           |
